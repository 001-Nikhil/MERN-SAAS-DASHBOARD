...
// ── Analytics APIs (Temporary for fixing server) ─────────────────

exports.getOverview = (req, res) => {
  res.json({ message: "Overview analytics working" });
};

exports.getRevenue = (req, res) => {
  res.json({ message: "Revenue analytics working" });
};

exports.getUserMetrics = (req, res) => {
  res.json({ message: "User metrics working" });
};

exports.seedAnalytics = (req, res) => {
  res.json({ message: "Seed analytics working" });
};